...
(function (global, Pattern, utils, widgets) {
    ...
    /**
     * Widget for panel with list of groups to which bull added test case
     *
     * @constructor
     */
    ...
    TestCaseGroups.prototype._createWidgets = function () {
        this.groupsModal = new widgets.ItemsListModal({
            title: 'Select the test case group',
            closable: true,
            hideApplyBtn: true,
            emptyMsg: 'Group ran out of ☹'
        }).initialize();
    };
    ...
    TestCaseGroups.prototype._getGroupBadgeHtml = function (group) {
		return (utils.HtmlGenerator.generateGroupBadge(group));
    };
